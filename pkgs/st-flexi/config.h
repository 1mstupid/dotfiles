 ...
 */
static char *font =
    "Cozette:weight=700:pixelsize=17:antialias=false:autohint=false";
...
float stat_alpha =
    ALPHA_INT; // constant alpha value that'll get added to grad_alpha
...
static const char *colorname[] = {
    /* 8 normal colors */
    "#eeeeee", /* 0: black   (col_gray1) */
    "#fd1b7c", /* 1: red     (col_red)   */
    "#b0b0b0", /* 2: green   (mapped to gray2) */
    "#e1e1e1", /* 3: yellow  (mapped to gray3) */
    "#eeeeee", /* 4: blue    (mapped to gray4) */
    "#fd1b7c", /* 5: magenta (col_red)   */
    "#b0b0b0", /* 6: cyan    (col_gray2) */
    "#fdf8d8", /* 7: white   (col_white) */

    /* 8 bright colors */
    "#eeeeee", /* 0: black   (col_gray1) */
    "#fd1b7c", /* 1: red     (col_red)   */
    "#ffffff", /* 2: green   (mapped to gray2) */
    "#e1e1e1", /* 3: yellow  (mapped to gray3) */
    "#eeeeee", /* 4: blue    (mapped to gray4) */
    "#fd1b7c", /* 5: magenta (col_red)   */
    "#c0c0c0", /* 6: cyan    (col_gray2) */
    "#fdf8d8", /* 7: white   (col_white) */
    ...
    "#bfc5d0", // cursor
    "#424242",
    "#1c1c1c", /* default foreground colour */
...
static Geometry geometry =
    PixelGeometry; // or PixelGeometry to use the below size
